...
// FIX: Removed the "ns3::energy::" prefix for ns-3.37 compatibility
void RunSclrpOptimization(NodeContainer nodes, EnergySourceContainer sources) {
    double w1 = 0.4;
    double w2 = 0.3;
    double w3 = 0.3;
...
int main(int argc, char *argv[])
{
    ...
    AnimationInterface anim("sclrp_proposed_anim.xml");
    anim.EnablePacketMetadata(true); 
    // FIX: Added the PHY and MAC counters to force NetAnim to see the Wi-Fi boundaries
    ...
    // FIX: Removed the "ns3::energy::" prefix here as well
