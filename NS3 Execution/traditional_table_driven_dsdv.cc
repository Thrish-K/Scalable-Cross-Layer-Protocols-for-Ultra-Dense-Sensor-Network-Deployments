...
#include <cstdlib>
#include <cstdio>
#include <unistd.h> // FIX: Required for terminal silencing on modern Linux
...
int main(int argc, char *argv[])
{
    ...
    // FIX: Moved AnimationInterface here and added counters for ns-3.37
    AnimationInterface anim("dsdv_table_driven_anim.xml");
    ...
    // FIX: Removed "ns3::energy::" for compatibility
    ...
    // Hardcoded DSDV overhead multiplier
    g_commOverhead = lostPackets + (txPackets * 0.25);
    ...
    std::cout << "======================================\n";
    std::cout << "Protocol Mode     = Baseline (DSDV)\n";
