...
int main(int argc, char *argv[])
{
    ...
    phy.SetErrorRateModel("ns3::NistErrorRateModel"); // Prevents the NS_ASSERT crash
    ...
    for (uint32_t i = 0; i < numFlows; i++) {
        ...
        clientApp.Start(Seconds(1.0 + i * 0.1)); // Staggered for stability
